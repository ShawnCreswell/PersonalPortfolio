...
const AuthorForm = () => {
  ...
  // const [imgUrl, setImgUrl] = useState("https://media.istockphoto.com/vectors/Portfolio-skull-emblem-illustration-with-crossed-sabers-vector-id1159854564?k=20&m=1159854564&s=612x612&w=0&h=0ODLCtqr5t-1TKWVh9Rj-EvQXAA67hWYoaUaQ6LvGJA=");
      ...
      <div className="card mt-5 border border-dark border-5">
        ...
        <div className="card-body" style={{ backgroundColor: "orange" }}>
          <form onSubmit={onSubmitHandler}>
            ...
            <p>
              <label>Portfolio Catch Phrase: </label>
              <br />
              <input
                type="text"
                onChange={(e) => setPortfolioPhrase(e.target.value)}
                value={portfolioPhrase}
              />
            </p>
